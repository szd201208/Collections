...
/**
 * Created by suzhudan on 2016/12/26.
 */
public class FolderTextView extends TextView {
        ...
        if (!mIsFold) {
            ...
            if (line < layout.getLineCount()) {
                ...
                if (index > 0) {
                    ...
                    String strWhichHasExactlyFoldLine = getText().subSequence(0, index).toString()+DEFAULT_UNFOLD_TEXT;
    ...
    private String tailorTextBackUp(String text) {
        ...
        String destStr = text + DEFAULT_ELLIPSIZE+DEFAULT_UNFOLD_TEXT ;
